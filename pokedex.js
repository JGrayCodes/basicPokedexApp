function logic() {
    ...
    // console.log( name + " - " + type + " - " + region + " region") 
    // remove once you have clear understanding
 ...
 *---------------------------------------------*/
    ...
    // used trim() method to remove any white space, "" denotes blank string
    {
        ...
        "Please make sure you have completed each entry"
    }
        else 
        {
            document.getElementById("invalidInput").innerHTML = " "
            ...
            /* Create a span element (const pokemonData) and put the pokemon 
            objects properties inside of it*/
            ...
            //create a line break so that the next node goes onto another line
            pokemonData.appendChild(document.createElement("br")); 
            ...
            const previewButton = `
                <form action="http://google.com/search" target="_blank">
                    ...
                    <input type="submit" value="Preview your Pokemon">
                </form>
            `
            ...
            pokedexEntry.innerHTML += previewButton; //previewButton not a node so can't use "appendChild()"
